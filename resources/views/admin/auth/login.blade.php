...
<head>
    ...
    <title>Admin Login | {{ config('site.sitename') }}</title>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center mb-3">
                            <img src="{{ asset('backend/img/lock.png') }}" alt="Locked">
                        </div>
                        <!-- /Logo -->
                        ...
                        <form class="mb-3" action="{{ route('admin.login.post') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('email_or_username') is-invalid @enderror" id="email"
                                    placeholder="Enter your email or username" name="email_or_username" value="{{ old('email_or_username') }}"  />
